...
public class ItemSteelSword extends ItemSword {
    ...
    public ItemSteelSword(Item.ToolMaterial material){
        //References the material in ModItems
        super(material);
        //Sets the unlocalized and registry name using data from Reference.class
        setUnlocalizedName(Reference.ModItems.STEELSWORD.getUnlocalizedName());
        setRegistryName(Reference.ModItems.STEELSWORD.getRegistryName());
