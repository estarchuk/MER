package mer.mod.teleporters;

import it.unimi.dsi.fastutil.longs.Long2ObjectMap;
import it.unimi.dsi.fastutil.longs.Long2ObjectOpenHashMap;
import mer.mod.blocks.BlockTrumpPortal;
...
public class TrumpTeleporter extends Teleporter
{
    ...
    public TrumpTeleporter(WorldServer worldIn, int dme2, double x, double y, double z)
    {
    ...
    public boolean makePortal(Entity entityIn)
    {
            ...
            for (int j7 = -1; j7 <= 1; ++j7)
            {
                for (int l7 = 1; l7 < 3; ++l7)
                {
                    for (int k8 = -1; k8 < 3; ++k8)
                    {
                        ...
                        boolean flag = k8 < 0;
                        this.worldServerInstance.setBlockState(new BlockPos(k9, k10, k11), flag ? ModBlocks.trumpiumblock.getDefaultState() : Blocks.AIR.getDefaultState());
        ...
        IBlockState iblockstate = ModBlocks.trumpportal.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
        ...
        for (int i8 = 0; i8 < 4; ++i8)
        {
            ...
            for (int i9 = 0; i9 < 4; ++i9)
            {
                for (int i10 = -1; i10 < 4; ++i10)
                {
                    ...
                    this.worldServerInstance.notifyNeighborsOfStateChange(blockpos, this.worldServerInstance.getBlockState(blockpos).getBlock(ModBlocks.trumpportal));
